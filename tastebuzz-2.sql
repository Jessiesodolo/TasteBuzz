...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2015 at 04:09 AM
...
(3, 'drink1', 'a nice drink', 'http://sixminutes.dlugan.com/wp-content/uploads/2011/12/eat-drink-speaking.jpg'),
(4, 'drink2', 'another nice drink', 'http://sixminutes.dlugan.com/wp-content/uploads/2011/12/eat-drink-speaking.jpg');
...
--
ALTER TABLE `dtraits`
  MODIFY `traitnum` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `userprefs`
--
ALTER TABLE `userprefs`
  MODIFY `prefnum` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
